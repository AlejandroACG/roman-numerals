...
/**
 * The Main class provides the entry point for the Roman
 * numeral converter program.
 */
...
public final class Main {
    ...
    /**
     Main method that reads an integer number from user input and
     converts it to its Roman numeral equivalent
